    ...
    <div class="min-h-screen py-3 space-y-8">
        <div class="grid grid-cols-1 md:grid-cols-2">
            ...
            <div class="min-w-[270px] md:flex items-center justify-end">
                <InertiaLinkButton :href="route('admin.return_list.create')" class="w-full md:w-auto bg-primary text-white">
        ...
        <div class="relative border border-gray-300 bg-white rounded-md shadow-sm shadow-gray-200 md:px-5 py-3">
            ...
            <TableContainer class="md:block hidden" :data-count="returns?.data?.length" :paginate-links="returns?.links">
                <template #table>
                    <div class="overflow-x-auto w-full">
                        <Table :items="returns?.data">
                            <template #table-header>
                                ...
                                <TableHeaderCell label="Note" class="min-w-[250px]"/>
                            ...
                            <template #table-data="{ item }">
                                ...
                                <TableDataCell ><p class="line-clamp-1">{{ item.note }}</p></TableDataCell>
                                <TableActionCell>
                                    <InertiaLinkButton
                                        :href="route('admin.return_list.edit', { return_list: item.id })"
                                    ...
                                    <NormalButton
                                        ...
                                        @click=" destroy(
                                                'Return',
                                                route('admin.return_list.destroy', { return_list: item?.id })
                                            )"
...
export default {
    ...
    methods: {
        ...
        handleDateChange(value) {
            ...
            this.$inertia.get(route('admin.return_list.index', { search, date: formattedDate }))
        }
    }
}
</script>
