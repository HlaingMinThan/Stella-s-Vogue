...
const toggle = () => {
    store.commit('toggleSideNav',!isSideNavOpen.value);
};
</script>
    ...
    <header class="sticky top-0 z-50 flex w-full bg-white drop-shadow-1">
        ...
        >
            <div class="flex items-center gap-2 sm:gap-4 lg:hidden">
                ...
                <button @click="toggle" type="button" class="bg-gray-50 border border-gray-300 px-4 py-2 rounded-md text-darkGray hover:bg-gray-100 transition-all" :class="{'text-primary border-primary':isSideNavOpen}">
        ...
        <form action="https://formbold.com/s/unique_form_id" method="POST">
          <div class="relative">
            ...
            <input
              ...
              class="w-full xl:w-125 bg-transparent pr-4 pl-9 focus:outline-none border-none focus:ring-0"
            />
          </div>
        </form>
      </div> -->
